...
public class AddressServiceImpl implements AddressService {
	...
	@Override
	public Set<AddressDTO> getAllUserAddresses(Integer userDetailsId, String userId, String typeOfUser)
			throws ShopEasyException {
		Optional<User> optional = userRepository.findById(userId);
		User user = optional
				.orElseThrow(() -> new ShopEasyException(ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_USER_ID + userId,
						HttpStatus.NOT_FOUND));
		Set<Address> addresses = null;
		switch (typeOfUser) {
		case "admin":
			Optional<AdminDetails> optional1 = adminDetailsRepository.findById(userDetailsId);
			AdminDetails adminDetails = optional1.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_ADMIN_DETAILS_ID + userDetailsId,
					HttpStatus.NOT_FOUND));
		...
		case "seller":
			...
			SellerDetails sellerDetails = optional2.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_SELLER_DETAILS_ID + userDetailsId,
					HttpStatus.NOT_FOUND));
		...
		case "customer":
			...
			CustomerDetails customerDetails = optional3.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_CUSTOMER_DETAILS_ID + userDetailsId,
					HttpStatus.NOT_FOUND));
	...
	public String addAddress(AddressDTO addressDTO, String typeOfUser) throws ShopEasyException {
		...
		case "admin":
			...
			AdminDetails adminDetails = optional3.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_ADMIN_DETAILS_ID + addressDTO.getAdminId(),
					HttpStatus.NOT_FOUND));
			Optional<Address> optional1 = addressRepository.findByHouseNoAndStreetAndAdminDetails(
					addressDTO.getHouseNo(), addressDTO.getStreet(), adminDetails);
			if (optional1.isPresent()) {
				throw new ShopEasyException(ShopEasyConstants.RECORD_ALREADY_EXIST + optional1.get().getAddressId(),
						HttpStatus.CONFLICT);
			}
		...
		case "seller":
			...
			SellerDetails sellerDetails = optional4.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_SELLER_DETAILS_ID + addressDTO.getSellerId(),
					HttpStatus.NOT_FOUND));
			Optional<Address> optional2 = addressRepository.findByHouseNoAndStreetAndSellerDetails(
					addressDTO.getHouseNo(), addressDTO.getStreet(), sellerDetails);
			if (optional2.isPresent()) {
				throw new ShopEasyException(ShopEasyConstants.RECORD_ALREADY_EXIST + optional2.get().getAddressId(),
						HttpStatus.CONFLICT);
			}
		...
		case "customer":
			...
			CustomerDetails customerDetails = optional5.orElseThrow(() -> new ShopEasyException(
					ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_CUSTOMER_DETAILS_ID + addressDTO.getCustomerId(),
					HttpStatus.NOT_FOUND));
			Optional<Address> optional6 = addressRepository.findByHouseNoAndStreetAndCustomerDetails(
					addressDTO.getHouseNo(), addressDTO.getStreet(), customerDetails);
			if (optional6.isPresent()) {
				throw new ShopEasyException(ShopEasyConstants.RECORD_ALREADY_EXIST + optional6.get().getAddressId(),
						HttpStatus.CONFLICT);
			}
		...
		User user = optional2.orElseThrow(() -> new ShopEasyException(
				ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_USER_ID + addressDTO.getUserId(), HttpStatus.NOT_FOUND));
	...
	public String updateAddress(Integer addressId, AddressDTO addressDTO) throws ShopEasyException {
		...
		Address address = optional.orElseThrow(() -> new ShopEasyException(
				ShopEasyConstants.NO_RECORDS_FOUND_FOR_GIVEN_ADDRESS_ID + addressId, HttpStatus.NOT_FOUND));
		...
		address.setSellerDetails(
				addressDTO.getSellerId() != null ? sellerDetailsRepository.findById(addressDTO.getSellerId()).get()
						: null);
		address.setCustomerDetails(addressDTO.getCustomerId() != null
				? customerDetailsRepository.findById(addressDTO.getCustomerId()).get()
				: null);
		address.setAdminDetails(
				addressDTO.getAdminId() != null ? adminDetailsRepository.findById(addressDTO.getAdminId()).get()
						: null);
